...
<!-- Page Content -->
    <div class="container-fluid" id="catalogo">
        ...
        <div class="row">
            ...
            <div class="col-lg-3" id="lista">

                <h1 class="my-4">HelpsGuide</h1>
            ...
            <div class="col-lg-9" id="catalogo">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" >
                        <div class="card h-100">
                            <a id="card-img" href="#"><img class="card-img-top img-fluid"  src="http://placehold.it/700x400" alt=""></a>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4" >
                        <div class="card h-100">
                            <a href="#" id="card-img"><img class="card-img-top img-fluid" src="http://placehold.it/700x400" alt=""></a>
                            <div class="card-block">
